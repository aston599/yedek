...
def add_application(user_id, username, merso_username, merso_screenshot, amg_username, amg_screenshot):
    ...
    cursor.execute('''
        ...
        (user_id, username, merso_username, merso_screenshot, amg_username, amg_screenshot)
        VALUES (?, ?, ?, ?, ?, ?)
    ''', (user_id, username, merso_username, merso_screenshot, amg_username, amg_screenshot))
